        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ asset('/admin/product/category/update') }}/{{ $categoryData->id }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="category" type="text" class="form-control " name="category" value="{{ $categoryData->category }}">
                                </div>
                            </div>
