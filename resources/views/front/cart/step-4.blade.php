...
@section('cart-content')
    ...
    {{-- <div class="order-detail"> --}}
        <div class="col-12 px-3 prog-bar">
            <div class="col-12 d-flex justify-content-around align-items-center px-3">
                ...
                <div class="progress mx-1">
                    <div class="progress-bar" role="progressbar" style="width: 33.33%" aria-valuenow="33.33%"
        ...
        @foreach ($order->details as $detail)
            ...
            <div class="col-12 product d-flex no-gutters ">
                ...
                <div class="col-4 d-flex justify-content-end align-items-center ">
                    <small class="mr-5">X{{ $detail->qty }}</small>
                    <small class="ml-2">${{ number_format($product->price * $detail->qty) }}</small>
                </div>
            </div>
            <hr class="my-3 w-100">
        @endforeach
        ...
        <div class="col-12 d-flex mb-5 ml-1">
            <h5 class="mr-5">地址</h5>
            <h5>{{ $order->zipcode }} {{ $order->county . $order->district . $order->address }}</h5>
        </div>
        ...
        <div class="col-12 d-flex justify-content-end no-gutters">
            <div class="col-4">
                ...
                <div class="row w-100 d-flex justify-content-between">
                    <p><small class="text-muted ">小計:</small></p>${{ number_format($order->price) }}
                </div>
                <div class="row w-100 d-flex justify-content-between">
                    <p><small class="text-muted ">運費:</small></p>${{ number_format($order->shipping_fee) }}
                </div>
                <div class="row w-100 d-flex justify-content-between">
                    <p><small class="text-muted ">總計:</small></p>
                    ${{ number_format($order->price + $order->shipping_fee) }}
                </div>
            </div>
        </div>
        <hr class="my-3 w-100">
