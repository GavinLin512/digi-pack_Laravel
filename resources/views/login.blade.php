...
<body>
    <div class="login-bg d-flex">
        <div class="col-6 left flex-column justify-content-center align-items-start">
            <h1 class="text-light">Keep it special</h1>
            <h2 class="text-light">Capture your personal memory in unique way, anywhere.</h2>
            <div class="row w-100">
                <div class="col-12 d-flex justify-content-center left-link">
                    <span>
        ...
        <div class="col-lg-6 right d-flex flex-column justify-content-center">
            ...
            <div class="row mb-4">
                <div class="col-12 d-flex justify-content-center">
                    <div class="rounded-circle links d-flex justify-content-center align-items-center">
                        <span class="text-light">f</span>
                    </div>
                    <div class="rounded-circle links d-flex justify-content-center align-items-center mx-3">
                        <span class="text-light">G+</span>
                    </div>
                    <div class="rounded-circle links d-flex justify-content-center align-items-center">
            ...
            <p class="text-light mx-auto">or use email your account</p>
            <div class="row">
                <div class="col-12 d-flex flex-column align-items-center ">
                    <input type="email" class="mb-4 p-3" placeholder="Email">
                    <input type="password" class="mb-2 p-3" placeholder="Password">
                </div>
            </div>
            <div class="row d-flex justify-content-center no-gutters">
                <div class="col-7 d-flex justify-content-end">
                    <p class="f-y-p">Forgot your password?</p>
                </div>
            </div>
            <div class="row mb-5">
                <div class="col-12 d-flex justify-content-center px-3">
                    <button type="button" class="btn btn-primary btn-lg mx-3">Sign In</button>
                </div>
            </div>
            <div class="row w-100 right-link mt-5 mx-auto">
                <div class="col-12 d-flex justify-content-center link">
                    <span>
                        <svg fill="#fff" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path
                                d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z">
